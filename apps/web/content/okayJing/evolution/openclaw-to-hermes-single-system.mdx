...
<Subtitle level={2}>0. 시작은 분업이었다</Subtitle>
...
<Subtitle level={2}>1. 진짜 병목은 모델 수가 아니었다</Subtitle>
...
<Subtitle level={2}>2. 남긴 것과 버린 것</Subtitle>
...
<Subtitle level={2}>3. migration에서 드러난 문제</Subtitle>
...
<Subtitle level={2}>4. 단일 체계가 단일 사고를 뜻하진 않는다</Subtitle>
