...
<Subtitle level={2}>0. 봇은 보통 멘션을 기다린다</Subtitle>
...
<Subtitle level={2}>1. free-response channel의 역할</Subtitle>
...
<Subtitle level={2}>2. allowed channel과 같이 봐야 한다</Subtitle>
...
<Subtitle level={2}>3. channel prompt는 행동 규칙을 바꾼다</Subtitle>
...
<Subtitle level={2}>4. 오케이징이 채널을 읽는다는 것</Subtitle>
