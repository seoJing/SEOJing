...
<Subtitle level={2}>0. Discord thread만으로는 부족했다</Subtitle>
...
<Subtitle level={2}>1. 그래서 local ticket first가 됐다</Subtitle>
...
<Subtitle level={2}>2. 티켓에 남기는 것</Subtitle>
...
<Subtitle level={2}>3. memory와 ticket은 다르다</Subtitle>
...
<Subtitle level={2}>4. 작은 명령 하나도 운영 규칙이 된다</Subtitle>
