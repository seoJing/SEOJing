...
<Subtitle level={2}>0. 자연어 보고만으로는 부족했다</Subtitle>
...
<Subtitle level={2}>1. 보고는 인수인계 문서다</Subtitle>
...
<Subtitle level={2}>2. Status가 먼저 나와야 하는 이유</Subtitle>
...
<Subtitle level={2}>3. Checks는 신뢰의 근거다</Subtitle>
...
<Subtitle level={2}>4. Discord 보고와 ticket report의 차이</Subtitle>
