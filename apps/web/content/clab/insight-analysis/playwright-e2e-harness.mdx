...
cover:
  src: "/images/content/clab/insight-analysis/playwright-e2e-harness/cover-riso.png"
  alt: "CLAB 인사이트 분석: AI가 만든 코드는 Playwright 하네스로 확인해야 한다 글의 리소그래프 스타일 대표 이미지 배경"
  caption: "Wikimedia Commons · Compaq Contura 430C keyboard and trackball detail not in use.jpg · CC BY 3.0 · risograph reinterpretation via Codex image generation · https://commons.wikimedia.org/wiki/File:Compaq_Contura_430C_keyboard_and_trackball_detail_not_in_use.jpg"
  kind: "generated"
---
