...
cover:
  src: "/images/content/clab/insight-analysis/ai-code-review-adoption/cover-riso.png"
  alt: "CLAB 인사이트 분석: AI 코드 리뷰는 정답 판정기가 아니라 하방을 막는 안전망이다 글의 리소그래프 스타일 대표 이미지 배경"
  caption: "Wikimedia Commons · Compaq Contura 430C keyboard and trackball detail.jpg · CC BY 3.0 · risograph reinterpretation via Codex image generation · https://commons.wikimedia.org/wiki/File:Compaq_Contura_430C_keyboard_and_trackball_detail.jpg"
  kind: "generated"
---
