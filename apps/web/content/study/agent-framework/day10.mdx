...
cover:
  src: "/images/content/study/agent-framework/day10/cover-riso.png"
  alt: "에이전트 프레임워크 스터디 Day 10: harness는 팀 아키텍처를 만드는 공장이다 글의 리소그래프 스타일 대표 이미지 배경"
  caption: "Wikimedia Commons · Apple Desktop Bus keyboard SMK - close up of locking SMK key switch on left.JPG · Public domain · risograph reinterpretation via Codex image generation · https://commons.wikimedia.org/wiki/File:Apple_Desktop_Bus_keyboard_SMK_-_close_up_of_locking_SMK_key_switch_on_left.JPG"
  kind: "generated"
---
