...
<Paragraph>
  React는 <strong>선언형(declarative)</strong>입니다. 화면이 어떻게 보여야
...
<Paragraph>
  ...
  Counter를 다시 실행해서 새로운 화면을 만들고, <code>&lt;p&gt;</code> 안의
  숫자만 바꿔줍니다.
</Paragraph>
...
<Paragraph>
  ...
  <strong>가상 DOM(Virtual DOM)</strong>을 만들어서 이전 상태와 비교한 뒤,
...
<Paragraph>
  ...
  예정이고, 지금은 <strong>"React를 더 편하게 쓰기 위한 틀"</strong> 정도로
  이해해두면 충분합니다.
</Paragraph>
